...
--
-- Host: 127.0.0.1
-- Generation Time: 11 Nov 2021 pada 07.24
-- Versi Server: 5.6.26
-- PHP Version: 5.6.12
...
--
ALTER TABLE `hasil_saw`
  MODIFY `id_hasil_saw` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `hasil_saw`
  ADD CONSTRAINT `hasil_saw_ibfk_1` FOREIGN KEY (`id_alternatif`) REFERENCES `alternatif` (`id_alternatif`) ON DELETE CASCADE ON UPDATE CASCADE;
