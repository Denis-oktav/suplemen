                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        ...
                                        <form class="user" action="<?php echo site_url('Login/save_daftar'); ?>" method="post">
                                            ...
                                            <div class="form-group">
                                                <input required autocomplete="off" type="text" class="form-control form-control-user" id="exampleInputUser" placeholder="Nama Lengkap" name="nama" />
                                            </div>
                                            <div class="form-group">
