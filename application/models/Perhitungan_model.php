<?php
    ...
    class Perhitungan_model extends CI_Model {
		...
		{
			$query = $this->db->query("SELECT max(sub_kriteria.nilai) as max, min(sub_kriteria.nilai) as min, kriteria.jenis as jenis FROM `penilaian` JOIN kriteria ON penilaian.id_kriteria=kriteria.id_kriteria JOIN sub_kriteria ON penilaian.id_sub_kriteria=sub_kriteria.id_sub_kriteria WHERE penilaian.id_kriteria='$id_kriteria';");
			return $query->row_array();
		}
